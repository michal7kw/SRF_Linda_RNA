...
```
    ...
    Processing model: Mouse_Dentate_Gyrus, sample: Emx1_Ctrl
...
![png](Mouse_Dentate_Gyrus_Emx1_Ctrl_files/Mouse_Dentate_Gyrus_Emx1_Ctrl_25_0.png)
    


    Saved cell type plot to results_Mouse_Dentate_Gyrus/Emx1_Ctrl_celltypes.png



    
![png](Mouse_Dentate_Gyrus_Emx1_Ctrl_files/Mouse_Dentate_Gyrus_Emx1_Ctrl_25_2.png)
...
![png](Mouse_Dentate_Gyrus_Emx1_Ctrl_files/Mouse_Dentate_Gyrus_Emx1_Ctrl_26_0.png)
    


    Saved confidence score plot to results_Mouse_Dentate_Gyrus/Emx1_Ctrl_confidence.png



    
![png](Mouse_Dentate_Gyrus_Emx1_Ctrl_files/Mouse_Dentate_Gyrus_Emx1_Ctrl_26_2.png)
...
```
    ...
    Saved annotated data to results_Mouse_Dentate_Gyrus/Emx1_Ctrl_annotated.h5ad
...
```
    ...
    Summary of cell types for Emx1_Ctrl using Mouse_Dentate_Gyrus model:
...
```
    ...
    Saved cell type summary to results_Mouse_Dentate_Gyrus/Emx1_Ctrl_cell_type_summary.csv
