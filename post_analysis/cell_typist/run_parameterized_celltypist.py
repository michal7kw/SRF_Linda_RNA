#!/usr/bin/env python3
"""
This script takes a template notebook and creates parameterized versions for different 
model-sample combinations for CellTypist analysis. It then executes each notebook.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Run parameterized CellTypist analysis for multiple combinations')
    parser.add_argument('--template', default='template_annotation_Mouse.ipynb', 
    ...
    for model_name in models:
        for sample_name in samples:
            ...
            output_path = os.path.join(output_dir, f"{model_name}_{sample_name}.ipynb")
